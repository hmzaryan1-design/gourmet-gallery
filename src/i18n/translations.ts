  ...
  testimonials: {
    ...
    items: {
      fr: [
        ...
        { name: "Groupe Saham", event: "Gala annuel — Hyatt Regency Casablanca", quote: "Le résultat a été à la hauteur de nos attentes. Nous avons apprécié le sens du détail dans tous les aspects de l'organisation de notre événement. Nos collaborateurs et invités en étaient satisfaits, qu'il s'agisse aussi bien de nos séminaires ou de notre dîner de gala. Nous serons heureux de collaborer à nouveau avec vous." },
      ],
      en: [
        ...
        { name: "Saham Group", event: "Annual Gala — Hyatt Regency Casablanca", quote: "The result met our expectations. We appreciated the attention to detail in all aspects of our event's organization. Our employees and guests were satisfied, whether for our seminars or our gala dinner. We will be happy to collaborate with you again." },
      ],
      ar: [
        ...
        { name: "مجموعة سهام", event: "حفل سنوي — حياة ريجنسي الدار البيضاء", quote: "كانت النتيجة على قدر تطلعاتنا. لقد قدرنا الاهتمام بالتفاصيل في جميع جوانب تنظيم فعاليتنا. كان موظفونا وضيوفنا راضين، سواء في ندواتنا أو في عشاء الغالا الخاص بنا. سنكون سعداء بالتعاون معكم مرة أخرى." },
      ],
    },
  },
